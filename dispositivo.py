...
class Dispositivo:
    ...
    def __init__(self, mqtt_broker, mqtt_port, mqtt_username, mqtt_password, root_topic, channel, key, tipo, lat="42.6818",lon="-2.9664",alt="475", userdata=None):
        ...
        self.node_name = "!abcd5f09" #mi nodo
